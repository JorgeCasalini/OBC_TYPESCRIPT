//Tipo literal - Variavel recebe literalmente um valor
// não sendo possivel atribuir outro valor a ele
// ajuda a lembrar de valores que pode ser atribuido a uma variavel

/*let option1: "Yes" | "No" | "Maybe"
